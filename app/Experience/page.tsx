...
const Experience = () => {
  return (
    <div className=" flex justify-center pt-16 landscape:p-24 pb-10 bg-zinc-200">
      <div className="mx-5  overflow-hidden  flex-col items-center sm:justify-center rounded-lg">
        ...
        <div className=" flex-cols rounded bg-white px-3 py-6 mx-4 ">
          ...
          <p className="text-black/30">
            ...
            100 designs in one year. Also responsable for social media post
            designs and product mockup for E-Commerse.
          </p>
        </div>

        <div className=" flex-cols rounded bg-white px-3 py-5 mx-3 mt-10">
          <div className=" h-full">
            <div className="flex items-end justify-between ">
              <div>
                <h1 className="text-4xl text-black font-f1">
              ...
              <div>
                <p className="text-black/30">Ahemdabad, Gujrat </p>
              </div>
            </div>
            <hr />
          </div>
        ...
        <div className=" flex-cols bg-white rounded px-3 py-5 mt-10 mx-3 ">
          <div className=" h-full">
            <div className="flex items-end justify-between ">
              <div>
                <h1 className="text-4xl text-black font-f1">
          ...
          <p className="text-black/30">
            Designated as designer for Illustations and printing for physical
            product.
          </p>
        </div>

        <div className="  mt-10  flex-cols bg-white rounded px-3 py-5 mx-3  ">
          <div className=" h-full">
          <div className="flex items-end justify-between ">
              <div>
                <h1 className="text-4xl text-black font-f1">
